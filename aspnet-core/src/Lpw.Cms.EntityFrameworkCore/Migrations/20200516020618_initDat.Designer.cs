...
namespace Lpw.Cms.Migrations
{
    ...
    [Migration("20200516020618_initDat")]
    partial class initDat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lpw.Cms.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lpw.Cms.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Lpw.Cms.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Lpw.Cms.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Lpw.Cms.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Lpw.Cms.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Lpw.Cms.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Lpw.Cms.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Lpw.Cms.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
